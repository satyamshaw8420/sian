...
/**
 * Builds the order/enquiry message. Items whose price is not printed are
 * listed without a value — the restaurant confirms them on WhatsApp.
 */
...
export function openWhatsAppForDish(dish: { name: string; price: number | null }, qty = 1): void {
