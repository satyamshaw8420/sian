...
const CONTENT: Record<"privacy" | "terms", { title: string; updated: string; blocks: Array<{ h: string; p: string }> }> = {
  privacy: {
    ...
    blocks: [
      {
        ...
        p: "Dish names, prices and availability shown on this site are indicative and can change without notice. The restaurant confirms the final price and availability when you order by phone, WhatsApp or a delivery partner.",
      },
      {
        h: "Orders & payment",
  ...
  return (
    <div className="min-h-screen bg-charcoal text-cream">
      <div className="mx-auto max-w-2xl px-5 py-16 sm:px-8 sm:py-24">
        ...
        <h1 className="mt-8 font-display text-4xl font-black sm:text-5xl">
          {content.title}
        </h1>
