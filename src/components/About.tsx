...
/* The four stations are the restaurant's real cuisine pillars — no invented history. */
const FIRES = [
  {
    n: "01",
    title: "The Wok",
    desc: "Chinese & Indo-Chinese — starters, hakka noodles, fried rice and schezwan heat.",
  },
  {
    n: "02",
    title: "The Dum Handi",
    desc: "Biryani sealed and steamed to order — chicken, mutton, egg and paneer.",
  },
  {
    n: "03",
    title: "The Tandoor",
    desc: "Charred kebabs and tikka — full and half portions, veg and non-veg.",
  },
  {
    n: "04",
    title: "The Steamer",
    desc: "Momos, soups and comfort bowls for the lighter craving.",
  },
];
